...
class BeautifulBarChart: UIView {
    ...
    private func showEntry(index: Int, barEntry: BeautifulBarEntry, animated: Bool, oldEntry: BeautifulBarEntry?) {
        ...
        mainLayer.addTextLayer(frame: barEntry.topBubbleEntry.textValueFrame, color: UIColor.white.cgColor, fontSize: 12, text: barEntry.data.textValue, animated: animated, oldFrame: oldEntry?.topBubbleEntry.textValueFrame)
        ...
        mainLayer.addTextLayer(frame: barEntry.bottomTitleFrame, color: cgColor, fontSize: 10, text: barEntry.data.title, animated: animated, oldFrame: oldEntry?.bottomTitleFrame)
    }
}
